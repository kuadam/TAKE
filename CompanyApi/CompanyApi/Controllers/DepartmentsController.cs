...
namespace CompanyApi.Controllers
{
	...
	public class DepartmentsController : ControllerBase
	{
		...
		{
			return await _context.Department.Select(d => DepatmenrtToDTO(d)).ToListAsync();
		}
		...
		public async Task<ActionResult<DepartmentDTO>> GetDepartment(int id)
		{
			...
			return DepatmenrtToDTO(department);
		}
		...
		private static DepartmentDTO DepatmenrtToDTO(Department department) => new DepartmentDTO
		{
			DepartmentId = department.DepartmentId,
			Name = department.Name
		};

		private static Department DTOToDepartment(DepartmentDTO department) => new Department
		{
			DepartmentId = department.DepartmentId,
			Name = department.Name
		};
